...
keep CASEID BL_MARKER FU1_MARKER FU2_MARKER RACE_DB SEX_DB REC_NREC BL_WKHRWEEK BL_TMSSTUDY BL_COLLMAJR BL_INTDMAJR BL_RSNSTREP BL_AFFOTHST BL_WKWSTDTS BL_DISCIDEA BL_HARDEREX BL_UGREEKS BL_URESHALL BL_UCULTURE BL_GLEADER BL_TMEXTRAC BL_COMDEGRE BL_UNDSOSTU BL_FAMWCOLL BL_COMWCOLL BL_LCGOODLK BL_SEESTMWO BL_SEDOWELL BL_AEHONSTD BL_HIGHDEGR BL_ATTNGRAD BL_OCCUASPI BL_OCCUASPO FU1_ACADEXMR FU1_MAJETCLG FU1_MAJETWRL FU1_GMSLEADR FU1_GMSLDACT FU1_GMSAFFRC FU1_GMSMENTR FU1_WKHRWEEK FU1_JOBRELMA FU1_AFFOTHST FU1_INDUSJ1CODE FU1_INCOMEJ1 FU1_INCOMEJ2 FU1_INCOMEJ3 FU1_INCOMEJ4 FU1_INCOMEJ5 FU1_JOBSATIS FU1_WKWSTDTS FU1_HARDEREX FU1_UGREEKS FU1_GLEADER FU1_NATLEAD FU1_LABLEAD FU1_DESTLEAD FU1_LEADDEF FU1_OTHLEAD FU1_CORRCOLL FU1_CARTEACH FU1_RGRPSSUP FU1_ANALSKL FU1_WRKINDEP FU1_COMMORAL FU1_WRITCLER FU1_ACDEXPRC FU1_LCGOODLK FU1_AENOTWEL FU1_SESATISF FU1_WLCOMPDG  FU1_OCCUASPI FU1_OCCUASPO
...
drop  if (BL_SEDOWELL == .)
drop  if (BL_AEHONSTD == .)
drop  if (FU1_ACDEXPRC == .)
drop  if (FU1_LCGOODLK == .)
drop  if (FU1_AENOTWEL == .)
// Carrer Prep
drop  if (BL_HIGHDEGR == .)
drop  if (BL_ATTNGRAD == .)
drop  if (FU1_CARTEACH == .)
drop   if (FU1_ANALSKL == .)
drop  if (FU1_WRKINDEP == .)
drop  if (FU1_COMMORAL == .)
drop  if (FU1_WRITCLER == .)
drop  if (FU1_WLCOMPDG == .)
*/
// //Elite Career
//drop  if (FU1_JOBSATIS == . & FU1_ACADEXMR == . & FU1_MAJETCLG == . & FU1_MAJETWRL == .)
// //Leadership Score
// drop  if (FU1_NATLEAD == .)
// drop  if (FU1_LABLEAD == .)
...
recode BL_LCGOODLK (5 = 0 "N/A") (4 = 1 "Disagree strongly") (3 = 2 "Disagree") (2 = 3 "Agree") (1 = 4 "Agree strongly") (0 = 0 "N/A"), gen(LCGOODLK_BL)
drop BL_LCGOODLK

recode BL_SEESTMWO (5 = 0 "N/A") (4 = 1 "Disagree strongly") (3 = 2 "Disagree") (2 = 3 "Agree") (1 = 4 "Agree strongly") (0 = 0 "N/A"), gen(SEESTMWO_BL)
drop BL_SEESTMWO

recode BL_SEDOWELL (5 = 0 "N/A") (4 = 1 "Disagree strongly") (3 = 2 "Disagree") (2 = 3 "Agree") (1 = 4 "Agree strongly") (0 = 0 "N/A"), gen(SEDOWELL_BL)
drop BL_SEDOWELL

recode BL_AEHONSTD (5 = 0 "N/A") (4 = 1 "Disagree strongly") (3 = 2 "Disagree") (2 = 3 "Agree") (1 = 4 "Agree strongly") (0 = 0 "N/A"), gen(AEHONSTD_BL)
drop BL_AEHONSTD

recode FU1_LCGOODLK (5 = 0 "N/A") (4 = 1 "Disagree strongly") (3 = 2 "Disagree") (2 = 3 "Agree") (1 = 4 "Agree strongly") (0 = 0 "N/A"), gen(LCGOODLK_FU1)
drop FU1_LCGOODLK

recode FU1_AENOTWEL (5 = 0 "N/A") (4 = 1 "Disagree strongly") (3 = 2 "Disagree") (2 = 3 "Agree") (1 = 4 "Agree strongly") (0 = 0 "N/A"), gen(AENOTWEL_FU1)
drop FU1_AENOTWEL

//Avg of Elite Career towards Positive

generate EXEPT_SCORE =  (BL_RSNSTREP + BL_COMDEGRE + BL_COMWCOLL + LCGOODLK_BL + SEESTMWO_BL + SEDOWELL_BL + AEHONSTD_BL + FU1_ACDEXPRC +LCGOODLK_FU1 + AENOTWEL_FU1)
//10
...
tab RACE, gen(races)
rename races1 AFR_AM
rename races2 AM_IND
rename races3 AAPI
...
regress ELITE_CAREER_SCORE INVOL_SCORE_LOG AFR_AM AM_IND AAPI SEX SCHOLAR
predict stdel, rstudent
summarize stdel
histogram stdel, norm
rvfplot

regress ELITE_CAREER_SCORE EXEPT_SCORE_LOG AFR_AM AM_IND AAPI SEX SCHOLAR
